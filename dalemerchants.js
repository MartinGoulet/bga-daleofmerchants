...
var LOCAL_STORAGE_ZOOM_KEY = "dale-merchants-zoom";
var LOCAL_STORAGE_JUMP_TO_FOLDED_KEY = "dale-merchants-jump-to-folded";
var DaleMerchants = (function () {
    function DaleMerchants() {
        this.TOOLTIP_DELAY = document.body.classList.contains("touch-device") ? 1500 : undefined;
        this.playersTables = [];
    }
    DaleMerchants.prototype.setup = function (gamedatas) {
        log(gamedatas);
    ...
    DaleMerchants.prototype.onEnteringState = function (stateName, args) {
        this.stateManager.onEnteringState(stateName, args);
    };
    DaleMerchants.prototype.onLeavingState = function (stateName) {
        this.stateManager.onLeavingState(stateName);
    };
    DaleMerchants.prototype.onUpdateActionButtons = function (stateName, args) {
        this.stateManager.onUpdateActionButtons(stateName, args);
    };
    DaleMerchants.prototype.addActionButtonDisabled = function (id, label, action) {
        this.addActionButton(id, label, action);
        this.disableButton(id);
    };
    DaleMerchants.prototype.addActionButtonClientCancel = function () {
        var _this = this;
    ...
    DaleMerchants.prototype.addActionButtonPass = function () {
        var _this = this;
    ...
    DaleMerchants.prototype.addActionButtonGray = function (id, label, action) {
        this.addActionButton(id, label, action, null, null, "gray");
    };
    DaleMerchants.prototype.addActionButtonRed = function (id, label, action) {
        this.addActionButton(id, label, action, null, null, "red");
    };
    DaleMerchants.prototype.createPlayerTables = function (gamedatas) {
        var _this = this;
    ...
    DaleMerchants.prototype.toggleButtonEnable = function (id, enabled, color) {
    ...
    DaleMerchants.prototype.disableButton = function (id) {
    ...
    DaleMerchants.prototype.enableButton = function (id, color) {
        if (color === void 0) { color = "blue"; }
        var el = document.getElementById(id);
        if (el) {
    ...
    DaleMerchants.prototype.getPlayerId = function () {
        return Number(this.player_id);
    };
    DaleMerchants.prototype.getPlayerTable = function (playerId) {
        return this.playersTables.find(function (playerTable) { return playerTable.player_id === playerId; });
    };
    DaleMerchants.prototype.restoreGameState = function () {
        log("restoreGameState");
        this.stateManager.restoreGameState();
        this.clearSelection();
        this.restoreServerGameState();
    };
    DaleMerchants.prototype.clearSelection = function () {
        log("clearSelection");
        document.querySelectorAll(".dm-selected").forEach(function (node) {
            node.classList.remove("dm-selected");
        });
        document.querySelectorAll(".dm-selectable").forEach(function (node) {
            node.classList.remove("dm-selectable");
        });
        document.querySelectorAll(".dm-deck-was-selected").forEach(function (node) {
            node.classList.remove("dm-deck-was-selected");
        });
    };
    DaleMerchants.prototype.setGamestateDescription = function (property) {
    ...
    DaleMerchants.prototype.setTooltip = function (id, html) {
        this.addTooltipHtml(id, html, this.TOOLTIP_DELAY);
    };
    DaleMerchants.prototype.takeAction = function (action, data, onSuccess, onComplete) {
        data = data || {};
        data.lock = true;
        ...
        this.ajaxcall("/dalemerchants/dalemerchants/".concat(action, ".html"), data, this, onSuccess, onComplete);
    };
    DaleMerchants.prototype.setupNotifications = function () {
        log("notifications subscriptions setup");
        this.notifManager.setup();
    };
    DaleMerchants.prototype.format_string_recursive = function (log, args) {
        try {
    ...
    DaleMerchants.prototype.formatGametext = function (rawText) {
        if (!rawText)
            return "";
        var value = rawText.replace(",", ",<br />").replace(":", ":<br />");
        return "<p>" + value.split(".").join(".</p><p>") + "</p>";
    };
    return DaleMerchants;
}());
...
define(["dojo", "dojo/_base/declare", "ebg/core/gamegui", "ebg/counter", "ebg/stock"], function (dojo, declare) {
    return declare("bgagame.dalemerchants", ebg.core.gamegui, new DaleMerchants());
});
